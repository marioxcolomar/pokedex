# Pokedex
Writen in go explore the world of catching Pokemon.
...
<!--[] Allow caught pokemon to evolve after some time-->
<!--[] Random encounters with wild pokemon-->
<!--[] Add support to different types of balls (Pokeballs, Great Balls, Ultra Balls, etc)-->
